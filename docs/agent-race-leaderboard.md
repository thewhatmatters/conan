...
|-------|-------|--------|-----------------|-----------------------------|---------|-------|
| T101 | US-101 a11y milestone | Integration (Claude + Codex + Grok) | `thewhatmatters/v2-t101-integration` @ `5e824f7` | `loop/conan-v2-astryx` @ `5e824f7` / tag `checkpoint/v2-t101` | http://127.0.0.1:5198 | Three-agent parts merged; title injection + ProjectTree icon alignment fix; 46 tests; typecheck/build clean. |
