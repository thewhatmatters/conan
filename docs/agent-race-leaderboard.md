...
|-------|-------|--------|-----------------|-----------------------------|---------|-------|
| p2c | US-301..US-305 Full composer | Claude | `thewhatmatters/v2-p2c-claude` @ `0b22a72` | `loop/conan-v2-astryx` @ `224aec1` / tag `checkpoint/v2-p2c` | http://127.0.0.1:5205 | Pins drawer, branch chip, provider·model·effort picker, @// input + paste/drop; 81/81 vitest; typecheck/build clean; v1 untouched. Minor provider/model picker UI refinements planned before final. |
