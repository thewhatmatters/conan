// Tremor AreaChart [v1.0.0] — vendored from tremorlabs/tremor (Apache-2.0).
// Rewired to Conan: cn() helper instead of cx, lucide-react icons instead of
// @remixicon, and colors via ../../lib/chartUtils (mapped to --color-chart-1..5).
