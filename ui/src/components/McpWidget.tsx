 ...
 *
 * The v4.6 US-014 inline Authenticate / Reconnect row actions were **removed**
 * — the throwaway-pty driver behind them didn't reliably complete the OAuth
 * flow in practice, and a half-working button is worse than no button. The
 * backend driver + routes (`src/mcp/auth.ts`, `POST /api/claude/mcp/:name/…`)
 * stay in tree for the future v4.7 US-105 watchdog, which can revisit the
 * reliability story before it surfaces UI again. For now users authenticate
 * MCP servers manually via the terminal's `/mcp` menu — same as before v4.6.
 */
