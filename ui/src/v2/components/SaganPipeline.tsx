...
import { stageFor, type SaganStage } from "../lib/saganStage.ts";

/** Below this surface width the board is replaced by the Overview list (AC7). */
export const SAGAN_PIPELINE_MIN_WIDTH = 520;

/** Re-exported so existing pipeline callers keep a single import path. */
export { stageFor, type SaganStage } from "../lib/saganStage.ts";
